    ...
    <footer className="max-container ">
      <div className="flex justify-between items-start gap-20 flex-wrap max-lg:flex-col">
        <div className="flex flex-col items-start">
          ...
          <p className="mt-6 text-white-400 text-base leading-7 font-montserrat sm:max-w-sm ">Discover stylish Nike arrivals, quality comfort, and innovation for
          your active life.</p>
      ...
      <div className="flex justify-between text-white-400 my-24 max-sm:flex-col max-sm:items-center">
